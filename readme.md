...
- Value Objects: [`src/modules/purchaseOrder/models/valueObjects.ts`](src/modules/purchaseOrder/models/valueObjects.ts), [`src/modules/inventory/models/quantity.ts`](src/modules/inventory/models/quantity.ts)
